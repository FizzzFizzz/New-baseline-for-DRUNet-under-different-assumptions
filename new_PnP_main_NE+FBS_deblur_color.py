...
model_path = "denoising/drunet_k=0_color_2024/models/6000_G.pth"
n_channels = 3
...
def search_args():
    ...
    # kernel 01, 
    search_range[0.04] = [1.3] # 25.7499, 0.6772
    # kernel 02, 
    # search_range[0.04] = [1.3] # 25.5745, 0.6748
    # kernel 03, 
    # search_range[0.04] = [1.3] # 26.3936, 0.7074
    # kernel 04, 
    # search_range[0.04] = [1.3] # 25.2850, 0.6582
    # kernel 05,
    # search_range[0.04] = [1.3] # 27.2930, 0.7417
    # kernel 06,
    # search_range[0.04] = [1.3] # 26.8998, 0.7260
    # kernel 07,
    # search_range[0.04] = [1.3] # 26.3069, 0.7079
    # kernel 08,
    # search_range[0.04] = [1.3] # 25.7855, 0.6883

    kernel_fp = '/home/dlwei/Documents/pnp_jacobian/kernels/kevin_8.png'
    # kevin's 8 kernels, CBSD68, 17.85 noise.
    # kernel 01, 
    search_range[0.05] = [1.1] # 24.9922, 0.6267
    # kernel 02, 
    # search_range[0.05] = [1.1] # 24.8532, 0.6296
    # kernel 03, 
    # search_range[0.05] = [1.1] # 25.6878, 0.6681
    # kernel 04, 
    # search_range[0.05] = [1.1] # 24.5546, 0.6129
    # kernel 05,
    # search_range[0.05] = [1.1] # 26.3854, 0.6934
    # kernel 06,
    # search_range[0.05] = [1.1] # 25.9816, 0.6750
    # kernel 07,
    # search_range[0.05] = [1.1] # 25.5080, 0.6619
    # kernel 08,
    # search_range[0.05] = [1.1] # 25.0214, 0.6433
